...
func NewRegexHandlerWithConfig(config *RegexConfig) *RegexHandler {
	...
	return &RegexHandler{
		BaseActionHandler: gismo.NewBaseActionHandler("regex", 150), // Medium priority
		config:            config,
	}
}

// ShouldHandle determines if this handler should process the event
func (h *RegexHandler) ShouldHandle(ctx context.Context, event gismo.HookMessage) bool {
	switch event.(type) {
...
func (h *RegexHandler) HandleUserPromptSubmit(ctx context.Context, msg *gismo.UserPromptSubmitMessage) (*gismo.HookResponse, error) {
...
func (h *RegexHandler) HandlePreToolUse(ctx context.Context, msg *gismo.PreToolUseMessage) (*gismo.HookResponse, error) {
...
func (h *RegexHandler) extractContent(msg *gismo.PreToolUseMessage) (string, error) {
