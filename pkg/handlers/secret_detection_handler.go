...
func NewSecretDetectionHandlerWithConfig(config *SecretDetectionConfig) *SecretDetectionHandler {
	...
	return &SecretDetectionHandler{
		BaseActionHandler: engine.NewBaseActionHandler("secret-detection", 200), // Higher priority than linting
...
func (h *SecretDetectionHandler) ShouldHandle(ctx context.Context, event engine.HookMessage) bool {
	switch event.(type) {
...
func (h *SecretDetectionHandler) HandleUserPromptSubmit(ctx context.Context, msg *engine.UserPromptSubmitMessage) (*engine.HookResponse, error) {
...
func (h *SecretDetectionHandler) HandlePreToolUse(ctx context.Context, msg *engine.PreToolUseMessage) (*engine.HookResponse, error) {
...
func (h *SecretDetectionHandler) extractFileContent(msg *engine.PreToolUseMessage) (string, string, error) {
	// Extract file path
