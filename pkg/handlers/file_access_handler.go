...
func NewFileAccessHandlerWithConfig(config *FileAccessConfig) *FileAccessHandler {
	...
	return &FileAccessHandler{
		BaseActionHandler: engine.NewBaseActionHandler("file-access", 300), // Highest priority for security
		config:            config,
	}
}

// ShouldHandle determines if this handler should process file access events
func (h *FileAccessHandler) ShouldHandle(ctx context.Context, event engine.HookMessage) bool {
...
func (h *FileAccessHandler) HandlePreToolUse(ctx context.Context, msg *engine.PreToolUseMessage) (*engine.HookResponse, error) {
...
func (h *FileAccessHandler) checkReadRestrictions(filePath string) (*engine.HookResponse, error) {
...
func (h *FileAccessHandler) checkWriteRestrictions(filePath string) (*engine.HookResponse, error) {
...
func (h *FileAccessHandler) extractFilePath(msg *engine.PreToolUseMessage) (string, error) {
